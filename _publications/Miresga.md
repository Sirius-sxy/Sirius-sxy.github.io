...
An extended journal version of this paper has been published in IEEE Transactions on Computers (Early Access): [Miresga: Achieving High-Performance and Reliable Layer-7 Load Balancing with Programmable Switches](/publication/Miresga-TC).
